...
urlpatterns = [
    ...
    url(r'portal/editor/project/edit', views.content_home, name='project_home_edit'),
    url(r'portal/editor/tutorial', views.content_home, name='tutorial_home'),
    url(r'portal/editor/tutorial/edit', views.content_home, name='tutorial_home_edit'),
    url(r'portal/editor/experience', views.content_home, name='experience_home'),
    url(r'portal/editor/experience/edit', views.content_home, name='experience_home_edit'),
    url(r'portal/editor/skills', views.content_home, name='skills_home'),
    url(r'portal/editor/skills/edit', views.content_home, name='skills_home_edit'),
    url(r'portal/editor/publication', views.content_home, name='publication_home'),
    url(r'portal/editor/publication/edit', views.content_home, name='publication_home_edit'),
