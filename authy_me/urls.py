...
urlpatterns = [
    ...
    url(r'portal/user/reset/$', password_reset, name='password_reset'),
    url(r'portal/user/reset/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', password_reset_confirm,
        name='password_reset_confirm'),
    url(r'portal/user/reset/done/$', password_reset_done, name='password_reset_done'),
    url(r'portal/user/done/$', password_reset_complete, name='password_reset_complete'),
