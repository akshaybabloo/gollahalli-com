...
<body id="page-top">
    ...
    <!-- Google Tag Manager -->
    <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-56JZX4"
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <img src="https://gravatar.com/avatar/457c55bc8c6bff07894da51767e408fb?s=200" class="img-circle activity_rounded" alt="Akshay Raj Gollahalli's photo">
                <hr class="light">
                <h1>Akshay Raj Gollahalli</h1>
                <p>
                    <a href="https://www.gollahalli.me/downloads/Gollahalli-CV.pdf" class="btn btn-lg btn-primary">Download CV<i class="fa fa-download"></i></a><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-justify">
                    ...
                    <hr class="light">
                    <p>My name is Akshay Raj Gollahalli (Akshay for short). I survive mostly on coffee. I am a designer, developer, software engineer, animal lover, <a href="http://www.kedri.aut.ac.nz/staff/students/akshay-raj-gollahalli">Ph.D. student</a>.
                    <p>In the year 1998, I went out with my mother, who is a social worker, to a free plastic surgery camp for poor in Hyderabad, India and then decided to become a doctor (a real one). That same year my father, who is an engineer, took me to a steel rolling mill, and then I decided to become an engineer. On 12th October 1999, my father bought me a computer, Intell Pentium III with 256 MB RAM (WHAT!?). I instantly fell in love with it.</p>
                    <p>My journey started with computers nearly 17 years ago, and I am very passionate about it. My interests are in research and development of Machine Learning, Neurocomputational Intelligence and Brain Computer Interface.</p>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <ol class="text-justify">
                        <li>Gollahalli, A. R. (2015). Brain-computer interfaces for virtual Quadcopters based on a spiking-neural network architecture - NeuCube. AUT University, Auckland. Retrieved from <a href="http://hdl.handle.net/10292/9249">http://hdl.handle.net/10292/9249</a></li>
                    </ol>
                    <h3>Abstract</h3>
                    <hr>
                    <ol class="text-justify">
                        <li>Gollahalli, A. R., & Kasabov, N. (2015). EEGRotor: A virtual Quad-Copter based on Brain Computer Interface. presented at the meeting of the 13<sup>th</sup> International Conference on Neuro-Computing and Evolving Intelligence 2015 (NCEI ‘15) Auckland. Retrieved from <a href="http://www.aut.ac.nz/__data/assets/pdf_file/0018/525051/Booklet-NCEI15.pdf">http://www.aut.ac.nz/__data/assets/pdf_file/0018/525051/Booklet-NCEI15.pdf</a></li>
                    </ol>
                    <h3>Poster</h3>
                    <hr>
                    <ol class="text-justify">
                        <li>Gollahalli, A. R., & Kasabov, N. (2015). EEGRotor: A virtual Quad-Copter based on Brain Computer Interface. presented at the meeting of the 13<sup>th</sup> International Conference on Neuro-Computing and Evolving Intelligence 2015 (NCEI ‘15) Auckland.</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <a href="#eegrotor_model" data-toggle="modal" data-target="#eegrotor_model" class="portfolio-box">
                        ...
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                ...
                                <p><i class="text-faded">A Virtual Environment for Brain Computer Interface Applications</i></p>
                                <i class="fa fa-clone port"></i>
                            </div>
                        </div>
                    </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>JCal is a Mortgage calculator and Unit conversion software written purely in Java. You can fork the repository <a href="https://github.com/gollahalli/JCal">here</a>.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="jmark_model" tabindex="-1" role="dialog" aria-labelledby="jmark_model_label">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>JMark is a Markdown editor written purely in Java. You can fork the repository <a href="https://github.com/gollahalli/JMark">here</a>.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>EEGRotor was developed in Unity 4 using C# and Javascript for a Brain Computer Interface (BCI)
                        software. You can fork the repository <a href="https://github.com/akshaybabloo/EEGRotor-VE">here</a>.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="smallurl_model" tabindex="-1" role="dialog" aria-labelledby="smallurl_model_label">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>SmallURL is a URL shortening tool written in Python3 using Django web framework. You can visit <a href="http://www.smallurl.cc">http://www.smallurl.cc</a> to test it.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="ruby_model" tabindex="-1" role="dialog" aria-labelledby="ruby_model_label">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>A tutorial on Ruby 4. You can fork the repository <a href="https://github.com/akshaybabloo/Ruby-notes">here</a>.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section id="contact">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <a class="twitter-timeline" href="https://twitter.com/akshaybabloo" data-widget-id="690023186424012800">Tweets by @akshaybabloo</a>
                </div>
    ...
    <script type="text/javascript">
        window.cookieconsent_options = {"message":"This website uses cookies to ensure you get the best experience on our website","dismiss":"Got it!","learnMore":"More info","link":"https://www.gollahalli.me/cookie-policy.html","theme":"dark-bottom"};
    </script>
