...
class WelcomeForm(forms.Form):
    ...
    title_same_as_company = forms.BooleanField()
    AWS_SECRET = forms.CharField(max_length=120, name='welcome_AWS_SECRET')
    AWS_SECRET_KEY = forms.CharField(max_length=120, name='welcome_AWS_SECRET_KEY')
    ...
    root_password = forms.CharField(max_length=30, name='welcome_root_password')